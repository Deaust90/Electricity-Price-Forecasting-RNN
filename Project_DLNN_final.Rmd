...
mean_summary <- tibble::tibble(
  ...
  `Base R` = c(mean(train_losses), mean(val_losses), mean(grad_sums_r)),
  TensorFlow = c(mean(tf_train_reported_mse_epoch), mean(tf_val_reported_mse_epoch), mean(grad_sums_tf))
)
